  ...
  <body>
    <?php
      ...
      if (isset($_POST['username'])){
        ...
        if($rows==1){
          ...
          echo "<br/><br/>";
          echo "<div class='form' style='top:50%;'> <h3 style='text-align:center;'>Incorrect UserName and Password!</h3> <br/> </div>";
          echo "<div class='form' style='left:50%;'> <a href='login.php' style='left:50%;font-weight:bold;text-align:center;color:blue;'>Login</a> </div>";
        }
      }else{
    ?>
    <div class="limiter">
    <div class="container-login100">
      <div class="wrap-login100">
        ...
        <form class="login100-form validate-form form p-l-55 p-r-55 p-t-178"action="" method="post" name="login"style="border-radius: 5px;">
